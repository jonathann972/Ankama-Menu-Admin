   ...
   public class UiRenderManager extends EventDispatcher
   {
      ...
      public function loadUi(uiData:UiData, spContainer:UiRootContainer, oProperties:* = null, checkCache:Boolean = true) : void
      {
         ...
         if(BeriliaConstants.USE_UI_CACHE)
         {
            ...
            if(Boolean(this._aRendering[sId]) && Boolean(!this._aCache[sId]) && checkCache)
            {
         ...
         if((Boolean(!this._aCache[sId]) || Boolean(this._aCache[sId] && this._aCache[sId].useCache)) && checkCache)
         {
      ...
      private function onUiRender(e:UiRenderEvent) : void
      {
         ...
         if(Boolean(!(e.uiTarget.uiData.module is PreCompiledUiModule) && uiDef && uiDef.useCache) && Boolean(!this._aCache[uiDef.name]) && BeriliaConstants.USE_UI_CACHE)
         {
